  ...
  return (
    <AuthLayout>
      <div className="mb-8 text-center sm:text-left">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Sign Up Account</h2>
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div className="space-y-1.5">
          ...
          <select
            id="role"
            name="role"
            className="w-full bg-white border border-gray-200 rounded-lg px-4 py-3 focus:ring-1 focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] text-sm outline-none transition-colors text-gray-900 font-medium"
            value={role}
